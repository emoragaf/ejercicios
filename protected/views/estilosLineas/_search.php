...
<?php $form = $this->beginWidget('GxActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model, 'lineas_id_linea'); ?>
		<?php echo $form->dropDownList($model, 'lineas_id_linea', GxHtml::listDataEx(Lineas::model()->findAllAttributes(null, true)), array('prompt' => Yii::t('app', 'All'))); ?>
	</div>
